...
import { FiShare2, FiChevronRight, FiPlus } from "react-icons/fi"
      ...
      <main className="max-w-[1280px] mx-auto px-6 md:px-12 py-8">
        ...
        <div className="mt-12 border-t-2 border-primary pt-8 flex justify-between items-center">
          ...
          <div className="flex gap-6">
            <button className="px-8 py-3 bg-muted/30 text-foreground text-xs font-mono hover:bg-muted/50 transition-colors uppercase">Save Comparison</button>
            <button className="px-8 py-3 bg-primary text-white text-xs font-mono hover:opacity-90 transition-all uppercase shadow-lg shadow-primary/20">Check Inventory</button>
          </div>
        </div>
      </main>
      <Footer />
