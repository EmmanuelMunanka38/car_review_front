    ...
    <div className="min-h-screen bg-background text-on-surface font-inter selection:bg-primary selection:text-white">
      ...
      <main className="max-w-[1280px] mx-auto px-6 md:px-12 py-8">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-24">
            ...
            {gallery.length > 0 && (
              <div className="grid grid-cols-5 gap-2 mt-4">
                {gallery.slice(0, 4).map((img) => (
                  <div key={img.id} className="aspect-video bg-muted/50 overflow-hidden cursor-pointer hover:opacity-80 transition-opacity">
          ...
          <div className="bg-muted/20 p-6 flex flex-col border border-border">
        ...
        {related.length > 0 && (
          <section className="mb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {related.map((car) => (
                <Link key={car.id} to={`/cars/${car.slug}`} className="group border border-border hover:border-foreground transition-colors cursor-pointer bg-white">
