    ...
    <footer className="bg-secondary text-white border-t border-border/10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-6 md:px-12 max-w-[1280px] mx-auto py-24">
        <div className="col-span-1 md:col-span-1">
          <h2 className="text-3xl font-archivo font-extrabold text-white mb-6 tracking-tighter uppercase">AUTOELITE</h2>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a className="w-10 h-10 border border-white/10 flex items-center justify-center text-white hover:bg-primary hover:border-primary transition-all rounded" href="#">
